        ...
        product.estado === "activo"
          ...
          : "bg-gray-300"
               ...
               <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                   ...
                   <a href="/admin/producto/${product.id}" class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-blue-100 hover:bg-blue-200 text-blue-600 hover:text-blue-800 transition-all duration-300 transform hover:scale-110 shadow-md ml-2" title="Ver detalles del producto">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
