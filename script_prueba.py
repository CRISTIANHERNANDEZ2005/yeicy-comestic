...
with app.app_context():
    ...
    productos_a_crear = [
        {'seudocategoria_id': seudo_labiales_mate.id, 'nombre': "Labial Mate Rojo Pasión", 'defaults': {'descripcion': "Labial mate de larga duración en tono rojo intenso", 'precio': 18.99, 'imagen_url': "https://tauro.com.co/wp-content/uploads/2021/08/7702433291194.jpg", 'existencia': 45, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "L'Oréal", 'estado': "activo"}},
        {'seudocategoria_id': seudo_labiales_mate.id, 'nombre': "Labial Mate Nude Elegante", 'defaults': {'descripcion': "Tonos nude mate para un look natural y sofisticado", 'precio': 16.50, 'imagen_url': "https://beautycreationscol.com/cdn/shop/files/Labial_en_barra_Nudex.png?v=1718324768", 'existencia': 30, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Maybelline", 'estado': "activo"}},
        {'seudocategoria_id': seudo_gloss.id, 'nombre': "Gloss Brillante Rosé", 'defaults': {'descripcion': "Gloss con efecto brillante y tono rosado", 'precio': 12.99, 'imagen_url': "https://example.com/gloss-rose.jpg", 'existencia': 40, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "NYX", 'estado': "activo"}},
        {'seudocategoria_id': seudo_mascaras.id, 'nombre': "Máscara Volumen Extremo", 'defaults': {'descripcion': "Máscara de pestañas para un volumen impactante", 'precio': 22.00, 'imagen_url': "https://example.com/mascara-volumen.jpg", 'existencia': 25, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Maybelline", 'estado': "activo"}},
        {'seudocategoria_id': seudo_sombras.id, 'nombre': "Paleta Sombras Nude", 'defaults': {'descripcion': "Paleta con 12 tonos nude para crear diferentes looks", 'precio': 29.99, 'imagen_url': "https://example.com/paleta-nude.jpg", 'existencia': 20, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Urban Decay", 'estado': "activo"}},
        {'seudocategoria_id': seudo_bases.id, 'nombre': "Base Fluida Larga Duración", 'defaults': {'descripcion': "Base de maquillaje fluida con acabado natural y larga duración", 'precio': 25.99, 'imagen_url': "https://example.com/base-fluida.jpg", 'existencia': 30, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Fenty Beauty", 'estado': "activo"}},
        {'seudocategoria_id': seudo_correctores.id, 'nombre': "Corrector Alta Cobertura", 'defaults': {'descripcion': "Corrector líquido de alta cobertura para ojeras e imperfecciones", 'precio': 14.50, 'imagen_url': "https://example.com/corrector-cobertura.jpg", 'existencia': 25, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "NARS", 'estado': "activo"}},
        {'seudocategoria_id': seudo_geles.id, 'nombre': "Gel Limpiador Piel Mixta", 'defaults': {'descripcion': "Gel limpiador suave para piel mixta, libre de jabón", 'precio': 15.50, 'imagen_url': "https://example.com/gel-limpiador.jpg", 'existencia': 35, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "La Roche-Posay", 'estado': "activo"}},
        {'seudocategoria_id': seudo_aguas_micelares.id, 'nombre': "Agua Micelar Sensibio", 'defaults': {'descripcion': "Agua micelar para pieles sensibles, sin alcohol", 'precio': 12.99, 'imagen_url': "https://example.com/agua-micelar.jpg", 'existencia': 40, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Bioderma", 'estado': "activo"}},
        {'seudocategoria_id': seudo_cremas.id, 'nombre': "Crema Hidratante 24h", 'defaults': {'descripcion': "Hidratación intensa durante 24 horas, para todo tipo de piel", 'precio': 18.75, 'imagen_url': "https://example.com/crema-hidratante.jpg", 'existencia': 30, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Neutrogena", 'estado': "activo"}},
        {'seudocategoria_id': seudo_serums.id, 'nombre': "Sérum Vitamina C", 'defaults': {'descripcion': "Sérum antioxidante con vitamina C para un brillo saludable", 'precio': 32.99, 'imagen_url': "https://example.com/serum-vitc.jpg", 'existencia': 25, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "The Ordinary", 'estado': "activo"}},
        {'seudocategoria_id': seudo_shampoo_hidratante.id, 'nombre': "Shampoo Hidratación Profunda", 'defaults': {'descripcion': "Shampoo con aceite de argán para cabellos secos", 'precio': 14.99, 'imagen_url': "https://example.com/shampoo-hidratante.jpg", 'existencia': 40, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Pantene", 'estado': "activo"}},
        {'seudocategoria_id': seudo_shampoo_anticaspa.id, 'nombre': "Shampoo Anticaspa Control", 'defaults': {'descripcion': "Controla la caspa y alivia el picor del cuero cabelludo", 'precio': 16.50, 'imagen_url': "https://example.com/shampoo-anticaspa.jpg", 'existencia': 35, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Head & Shoulders", 'estado': "activo"}},
        {'seudocategoria_id': seudo_mascarillas.id, 'nombre': "Mascarilla Reparadora", 'defaults': {'descripcion': "Tratamiento intensivo para cabellos dañados", 'precio': 21.99, 'imagen_url': "https://example.com/mascarilla-reparadora.jpg", 'existencia': 25, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Garnier", 'estado': "activo"}},
        {'seudocategoria_id': seudo_aceites.id, 'nombre': "Aceite de Argán Puro", 'defaults': {'descripcion': "Aceite 100% puro para nutrición y brillo del cabello", 'precio': 19.99, 'imagen_url': "https://example.com/aceite-argan.jpg", 'existencia': 30, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Moroccanoil", 'estado': "activo"}},
        {'seudocategoria_id': seudo_eau_de_parfum.id, 'nombre': "Floral Dream EDP", 'defaults': {'descripcion': "Fragancia floral con notas de jazmín y vainilla", 'precio': 65.00, 'imagen_url': "https://example.com/floral-dream.jpg", 'existencia': 15, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Chanel", 'estado': "activo"}},
        {'seudocategoria_id': seudo_eau_de_toilette.id, 'nombre': "Fresh Breeze EDT", 'defaults': {'descripcion': "Fragancia fresca con notas cítricas y florales", 'precio': 45.99, 'imagen_url': "https://example.com/fresh-breeze.jpg", 'existencia': 20, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Dior", 'estado': "activo"}},
        {'seudocategoria_id': seudo_parfum_hombre.id, 'nombre': "Wood Essence Parfum", 'defaults': {'descripcion': "Fragancia masculina con notas amaderadas y especiadas", 'precio': 70.00, 'imagen_url': "https://example.com/wood-essence.jpg", 'existencia': 12, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Hugo Boss", 'estado': "activo"}},
        {'seudocategoria_id': seudo_colonias.id, 'nombre': "Blue Ocean Cologne", 'defaults': {'descripcion': "Colonia fresca con notas acuáticas y amaderadas", 'precio': 38.50, 'imagen_url': "https://example.com/blue-ocean.jpg", 'existencia': 18, 'stock_minimo': 10, 'stock_maximo': 100, 'marca': "Calvin Klein", 'estado': "activo"}},
    ]
