        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="font-bold text-xl">YE&CY COSMETIC</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Tu destino de confianza para productos de belleza de alta calidad. 
              Ofrecemos una amplia selección de cosméticos y productos de cuidado personal.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/novedades" className="text-gray-300 hover:text-white transition-colors">
                  Novedades
                </Link>
              </li>
              <li>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="text-lg font-semibold mb-6">Atención al Cliente</h3>
            <ul className="space-y-3">
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              © {currentYear} YE&CY COSMETIC. Todos los derechos reservados.
            </div>
